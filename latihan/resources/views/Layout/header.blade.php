...
<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
    <img src="{{ asset('img/Affan.jpg') }}" class="user-image img-circle elevation-2" alt="User Image">
    <span class="d-none d-md-inline">Affan Abdul Majid Syahrul</span>
</a>
<ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
    <!-- User image -->
        <li class="user-header bg-primary">
        <img src="{{ asset('img/Affan.jpg') }}" class="img-circle elevation-2" alt="User Image">

        <p>
            Affan Abdul Majid Syahrul - Mahasiswa
